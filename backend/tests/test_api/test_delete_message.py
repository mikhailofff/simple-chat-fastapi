...
@pytest.mark.asyncio
async def test_delete_message_as_unauthorized(async_client: httpx.AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_delete_message_with_invalid_token(async_client: httpx.AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_delete_message_with_expired_token(async_client: httpx.AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_delete_message(async_client: httpx.AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_delete_unknown_message(async_client: httpx.AsyncClient) -> None:
    access_token = async_client.cookies.get("access_token")
    message_request = {"id": "1"}
